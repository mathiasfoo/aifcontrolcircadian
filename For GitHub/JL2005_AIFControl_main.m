...
C = [mLHY(1) pcLHY(1) pnLHY(1) mTOC1(1) pcTOC1(1) pnTOC1(1) pP(1) 0*ones(1,2)];
Cinit = [mLHY(1) pcLHY(1) pnLHY(1) mTOC1(1) pcTOC1(1) pnTOC1(1) pP(1) 0*ones(1,2)];

for t = 1:length(TL)
    tspan = [t t+1]
    EL = TL(t);    
    Rf = mLHYref(t);
    [T,C] = ode45('JL2005_AIFControl_ODE',tspan,C(end,:));
