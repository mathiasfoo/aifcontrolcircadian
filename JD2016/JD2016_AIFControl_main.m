...
C = [mLHY(1) pLHY(1) mP97(1) pP97(1) mP51(1) pP51(1) mEL(1) pEL(1) pP(1) mPIF(1) pPIF(1) pHYP(1) 0*ones(1,2)];
Cinit = [mLHY(1) pLHY(1) mP97(1) pP97(1) mP51(1) pP51(1) mEL(1) pEL(1) pP(1) mPIF(1) pPIF(1) pHYP(1) 0*ones(1,2)];
...
for t = 1:length(TL)
    ...
    EL = TL(t);    
    Rf = pHYPref(t);
    [T,C] = ode45('JD2016_AIFControl_ODE',tspan,C(end,:));
...
figure(1)
subplot(4,4,1)
plot(tp,ProteinLevel(:,1),'LineWidth',2)
title('mLHY')
xlim([0 95])
ylim([0 2])
xticks([0:24:96])
...
subplot(4,4,2)
plot(tp,ProteinLevel(:,2),'LineWidth',2)
title('pcLHY')
xlim([0 95])
ylim([0 3])
xticks([0:24:96])
...
subplot(4,4,3)
plot(tp,ProteinLevel(:,3),'LineWidth',2)
title('mP97')
xlim([0 95])
ylim([0 4])
xticks([0:24:96])
...
subplot(4,4,4)
plot(tp,ProteinLevel(:,4),'LineWidth',2)
title('pP97')
xlim([0 95])
ylim([0 10])
xticks([0:24:96])
...
subplot(4,4,5)
plot(tp,ProteinLevel(:,5),'LineWidth',2)
title('mP51')
xlim([0 95])
ylim([0 2])
xticks([0:24:96])
...
subplot(4,4,6)
plot(tp,ProteinLevel(:,6),'LineWidth',2)
title('pP51')
xlim([0 95])
ylim([0 2])
xticks([0:24:96])
...
subplot(4,4,7)
plot(tp,ProteinLevel(:,7),'LineWidth',2)
title('mEL')
xlim([0 95])
ylim([0 2])
xticks([0:24:96])
...
subplot(4,4,8)
plot(tp,ProteinLevel(:,8),'LineWidth',2)
title('pEL')
xlim([0 95])
ylim([0 3])
xticks([0:24:96])
...
subplot(4,4,9)
plot(tp,ProteinLevel(:,9),'LineWidth',2)
title('P')
xlim([0 95])
ylim([0 1])
xticks([0:24:96])
...
subplot(4,4,10)
plot(tp,ProteinLevel(:,10),'LineWidth',2)
title('mPIF')
xlim([0 95])
ylim([0 1])
xticks([0:24:96])
...
subplot(4,4,11)
plot(tp,ProteinLevel(:,11),'LineWidth',2)
title('pPIF')
xlim([0 95])
ylim([0 1])
xticks([0:24:96])
...
subplot(4,4,13)
plot(tp,ProteinLevel(:,13),'LineWidth',2)
title('Z1')
xlim([0 95])
xticks([0:24:96])

subplot(4,4,14)
plot(tp,ProteinLevel(:,14),'LineWidth',2)
title('Z4')
xlim([0 95])
xticks([0:24:96])
